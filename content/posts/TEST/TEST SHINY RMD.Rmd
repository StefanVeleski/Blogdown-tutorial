...
Main_dataset <- read_csv("C:/Users/Stefan/OneDrive - MUNI/Github/Blogdown-tutorial/content/posts/TEST/Main dataset.csv")
...
plot2 <- ggplot(Main_dataset, aes(x = Rank1, y = Syllabi, label = Title)) +
    geom_point(alpha = 0.8, size = 3, color = "gray48") +
    scale_x_log10() +
    labs(
